...
export default function ManagerSalesPage() {
  ...
  const addToCart = (
    ...
    showToast("Added to Bill", `${item.name} added to cart.`, "info");
  };
  ...
  // Sales Table Columns for History Tab
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-amber-400 text-xs font-bold uppercase tracking-widest mb-1">
            ...
            <span>Manager Point of Sale & Cashier Terminal</span>
          </div>
            ...
            <div className="p-4 rounded-2xl bg-dark-card/90 border border-slate-700/80 backdrop-blur-xl space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-900 border border-slate-700 rounded-xl text-xs text-white placeholder-slate-500 focus:border-amber-500 focus:outline-none"
                />
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {filteredProcedures.map((trt) => (
                      <div
                        key={trt.treatmentId}
                        className="p-4 rounded-2xl bg-dark-card/90 border border-slate-700/80 hover:border-amber-500/50 transition-all flex flex-col justify-between gap-3 group"
                      >
                        <div>
                          <div className="flex items-start justify-between gap-2">
                            ...
                            <span className="px-2 py-0.5 rounded-md bg-amber-500/10 border border-amber-500/30 text-amber-300 text-[10px] whitespace-nowrap font-medium">
                              {trt.duration}m
                            </span>
                          </div>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-800">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-600 hover:bg-amber-500 text-white font-bold text-xs shadow-md transition-all"
                          >
              ...
              <form onSubmit={handleCheckout} className="space-y-4 pt-3 border-t border-slate-800 text-xs">
                  ...
                  {patientMode === "existing" ? (
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <input
                        ...
                        className="px-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-white focus:border-amber-500 focus:outline-none"
                      />
                      <input
                        type="text"
                        value={patientPhone}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-white focus:border-amber-500 focus:outline-none capitalize"
                    >
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-2xl font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-glow ${
                    cart.length === 0
                      ? "bg-slate-800 text-slate-500 cursor-not-allowed border border-slate-700"
                      : "bg-gradient-to-r from-amber-600 via-gold-600 to-amber-500 hover:from-amber-500 hover:to-gold-500 text-white shadow-xl"
                  }`}
                >
