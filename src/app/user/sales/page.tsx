...
export default function UserSalesPage() {
  ...
  const handleCheckout = (e: React.FormEvent) => {
    ...
    // Primary procedure/product title for backwards compatibility
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-emerald-400 text-xs font-bold uppercase tracking-widest mb-1">
            ...
            <span>Front Desk Point of Sale & Billing</span>
          </div>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-white font-display">
            Reception Sales Counter
          </h2>
          <p className="text-xs sm:text-sm text-slate-400 font-light mt-0.5">
            Sell aesthetic procedures and dispense medicines with automatic stock deduction and official print receipts.
          </p>
        </div>
            ...
            <div className="p-4 rounded-2xl bg-dark-card/90 border border-slate-700/80 backdrop-blur-xl space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-900 border border-slate-700 rounded-xl text-xs text-white placeholder-slate-500 focus:border-emerald-500 focus:outline-none"
                />
              </div>
              ...
              <form onSubmit={handleCheckout} className="space-y-4 pt-3 border-t border-slate-800 text-xs">
                  ...
                  {patientMode === "existing" ? (
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <input
                        ...
                        className="px-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-white focus:border-emerald-500 focus:outline-none"
                      />
                      <input
                        type="text"
                        value={patientPhone}
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Prescribed post-laser skincare kit"
                    className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-white focus:border-emerald-500 focus:outline-none"
                  />
                </div>
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-2xl font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-glow ${
                    cart.length === 0
                      ? "bg-slate-800 text-slate-500 cursor-not-allowed border border-slate-700"
                      : "bg-gradient-to-r from-emerald-600 via-teal-600 to-clinic-600 hover:from-emerald-500 hover:to-clinic-500 text-white shadow-xl"
                  }`}
                >
